...
run "$ROOT/migration/007_task_records.sql"
run "$ROOT/migration/008_task_progress.sql"
run "$ROOT/migration/009_role_data_scope.sql"
run "$ROOT/migration/010_system_roles.sql"
run "$ROOT/migration/011_recognition_checkpoint.sql"
run "$ROOT/migration/012_recognition_queue.sql"
