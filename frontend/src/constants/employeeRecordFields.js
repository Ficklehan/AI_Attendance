...
export function buildEmployeeRecordFieldDefs(t) {
  return [
    ...
    { field: 'NO', label: t('taskEdit.workerNumber'), dataIndex: 'no', key: 'no', filterType: FILTER_TYPES.TEXT },
    { field: 'NOM_PRENOM', label: t('taskEdit.name'), dataIndex: 'name', key: 'name', filterType: FILTER_TYPES.TEXT, ellipsis: false },
    { field: 'Pays', label: t('taskEdit.countryField'), dataIndex: 'country', key: 'country', filterType: FILTER_TYPES.TEXT },
    { field: 'Entrepot', label: t('taskEdit.warehouse'), dataIndex: 'warehouse', key: 'warehouse', filterType: FILTER_TYPES.TEXT },
    { field: 'Date', label: t('taskEdit.date'), dataIndex: 'date', key: 'date', filterType: FILTER_TYPES.DATE },
    { field: 'AGENCE_INTERIMAIRE', label: t('taskEdit.agency'), dataIndex: 'agency', key: 'agency', filterType: FILTER_TYPES.TEXT },
    { field: 'HORAIRES_DU_TRAVAIL', label: t('taskEdit.shift'), dataIndex: 'shift', key: 'shift', filterType: FILTER_TYPES.TEXT },
